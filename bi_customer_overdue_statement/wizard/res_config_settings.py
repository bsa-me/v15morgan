...
class ResConfigSettings(models.TransientModel):
    ...
    filter_statement = fields.Selection([('filter_only','View Only Filter Statements'),('all_statement','View All Statements Along With Filter Statements')],string="Filter Statement",related='company_id.filter_statement',readonly=False)
