...
class Slide(models.Model):
	...
	slide_type = fields.Selection(selection_add=[('iframe', 'iframe')],ondelete={'iframe': 'cascade'})
	iframe_content = fields.Text('iframe content')
	...
	def _compute_embed_code(self):
		...
		for record in self:
			if record.slide_type == 'iframe':
				record.embed_code = record.iframe_content
